...
module.exports = {
    ...
    actionSignIn: async (req, res) => {
        try {
            ...
            if(!user) {
                req.flash('alertMessage', 'User yang anda masukkan tidak aaa!!');
    ...
    viewDashboard: async (req, res) => {
        try {
            ...
            res.render('admin/dashboard/vdashboar', {
    ...
    viewCategory: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus');
            const alert = { message: alertMessage, status: alertStatus };
            res.render('admin/category/vcategory', { 
                category,
                alert,
    ...
    viewBooking: async (req,res) => {
        try {
            const booking = await Booking.find()
                .populate('memberId')
                .populate('bankId');
            res.render('admin/booking/vbooking', {
